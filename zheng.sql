...
-- Records of upms_log
-- ----------------------------
INSERT INTO `upms_log` VALUES ('638', '修改系统', 'admin', '1496482968582', '46', 'http://upms.zhangshuzheng.cn:1111', '/manage/system/update/6', 'http://upms.zhangshuzheng.cn:1111/manage/system/update/6', 'POST', '{basepath=[6],icon=[1],name=[test],banner=[http://shuzheng.oss-cn-shanghai.aliyuncs.com/20170603/K9SeEgAb4WaMzv2UNtMKaDDEJPdtinPQ.png],description=[5],theme=[#408080],title=[test],status=[1]}', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.36', '127.0.0.1', 'online.duobao.upms.common.constant.UpmsResult@709962ff', 'upms:system:update');
INSERT INTO `upms_log` VALUES ('639', '系统列表', 'admin', '1496482968704', '7', 'http://upms.zhangshuzheng.cn:1111', '/manage/system/list', 'http://upms.zhangshuzheng.cn:1111/manage/system/list', 'GET', 'order=asc&offset=0&limit=10', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.36', '127.0.0.1', '{total=7, rows=[UpmsSystem [Hash = 1641885411, systemId=1, icon=zmdi zmdi-shield-security, banner=/resources/duobao-admin/images/duobao-upms.png, theme=#29A176, basepath=http://upms.zhangshuzheng.cn:1111, status=1, name=duobao-upms-server, title=权限管理系统, description=用户权限管理系统（RBAC细粒度用户权限、统一后台、单点登录、会话管理）, ctime=1, orders=1], UpmsSystem [Hash = 2020796001, systemId=2, icon=zmdi zmdi-wikipedia, banner=/resources/duobao-admin/images/duobao-cms.png, theme=#455EC5, basepath=http://cms.zhangshuzheng.cn:2222, status=1, name=duobao-cms-admin, title=内容管理系统, description=内容管理系统（门户、博客、论坛、问答等）, ctime=2, orders=2], UpmsSystem [Hash = 744121144, systemId=3, icon=zmdi zmdi-paypal-alt, banner=/resources/duobao-admin/images/duobao-pay.png, theme=#F06292, basepath=http://pay.zhangshuzheng.cn:3331, status=1, name=duobao-pay-admin, title=支付管理系统, description=支付管理系统, ctime=3, orders=3], UpmsSystem [Hash = -2076287598, systemId=4, icon=zmdi zmdi-account, banner=/resources/duobao-admin/images/duobao-ucenter.png, theme=#6539B4, basepath=http://ucenter.zhangshuzheng.cn:4441, status=1, name=duobao-ucenter-home, title=用户管理系统, description=用户管理系统, ctime=4, orders=4], UpmsSystem [Hash = -1546531115, systemId=5, icon=zmdi zmdi-cloud, banner=/resources/duobao-admin/images/duobao-oss.png, theme=#0B8DE5, basepath=http://oss.zhangshuzheng.cn:7771, status=1, name=duobao-oss-web, title=存储管理系统, description=存储管理系统, ctime=5, orders=5], UpmsSystem [Hash = -22665516, systemId=6, icon=1, banner=http://shuzheng.oss-cn-shanghai.aliyuncs.com/20170603/K9SeEgAb4WaMzv2UNtMKaDDEJPdtinPQ.png, theme=#408080, basepath=6, status=1, name=test, title=test, description=5, ctime=1496463790282, orders=1496463790282], UpmsSystem [Hash = 344597582, systemId=7, icon=, banner=,,,, theme=#ff0000, basepath=, status=1, name=add, title=add, description=, ctime=1496465063224, orders=1496465063224]]}', 'upms:system:read');
...
INSERT INTO `upms_log` VALUES ('642', '修改系统', 'admin', '1496482987575', '41', 'http://upms.zhangshuzheng.cn:1111', '/manage/system/update/7', 'http://upms.zhangshuzheng.cn:1111/manage/system/update/7', 'POST', '{basepath=[],icon=[],name=[add],banner=[http://shuzheng.oss-cn-shanghai.aliyuncs.com/20170603/b8VbzvSHqfsvVXrn9L5aG5ARrsD0UMDt.jpg],description=[],theme=[#ff0000],title=[add],status=[1]}', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.36', '127.0.0.1', 'online.duobao.upms.common.constant.UpmsResult@563fe43a', 'upms:system:update');
...
-- ----------------------------
INSERT INTO `upms_system` VALUES ('1', 'zmdi zmdi-shield-security', '/resources/duobao-admin/images/duobao-upms.png', '#29A176', 'http://upms.zhangshuzheng.cn:1111', '1', 'duobao-upms-server', '权限管理系统', '用户权限管理系统（RBAC细粒度用户权限、统一后台、单点登录、会话管理）', '1', '1');
INSERT INTO `upms_system` VALUES ('2', 'zmdi zmdi-wikipedia', '/resources/duobao-admin/images/duobao-cms.png', '#455EC5', 'http://cms.zhangshuzheng.cn:2222', '1', 'duobao-cms-admin', '内容管理系统', '内容管理系统（门户、博客、论坛、问答等）', '2', '2');
INSERT INTO `upms_system` VALUES ('3', 'zmdi zmdi-paypal-alt', '/resources/duobao-admin/images/duobao-pay.png', '#F06292', 'http://pay.zhangshuzheng.cn:3331', '1', 'duobao-pay-admin', '支付管理系统', '支付管理系统', '3', '3');
INSERT INTO `upms_system` VALUES ('4', 'zmdi zmdi-account', '/resources/duobao-admin/images/duobao-ucenter.png', '#6539B4', 'http://ucenter.zhangshuzheng.cn:4441', '1', 'duobao-ucenter-home', '用户管理系统', '用户管理系统', '4', '4');
INSERT INTO `upms_system` VALUES ('5', 'zmdi zmdi-cloud', '/resources/duobao-admin/images/duobao-oss.png', '#0B8DE5', 'http://oss.zhangshuzheng.cn:7771', '1', 'duobao-oss-web', '存储管理系统', '存储管理系统', '5', '5');
...
-- ----------------------------
INSERT INTO `upms_user` VALUES ('1', 'admin', '3038D9CB63B3152A79B8153FB06C02F7', '66f1b370c660445a8657bf8bf1794486', '张恕征', '/resources/duobao-admin/images/avatar.jpg', '', '469741414@qq.com', '1', '0', '1');
INSERT INTO `upms_user` VALUES ('2', 'test', '285C9762F5F9046F5893F752DFAF3476', 'd2d0d03310444ad388a8b290b0fe8564', '张恕征', '/resources/duobao-admin/images/avatar.jpg', '', '469741414@qq.com', '1', '0', '1493394720495');
