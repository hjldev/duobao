package online.duobao.upms.client.shiro.filter;

import com.alibaba.fastjson.JSONObject;
import online.duobao.common.util.PropertiesFileUtil;
import online.duobao.common.util.RedisUtil;
import online.duobao.upms.client.shiro.session.UpmsSessionDao;
import online.duobao.upms.client.util.RequestParameterUtil;
import online.duobao.upms.common.constant.UpmsConstant;
...
public class UpmsAuthenticationFilter extends AuthenticationFilter {
    ...
    // 局部会话key
    private final static String ZHENG_UPMS_CLIENT_SESSION_ID = "duobao-upms-client-session-id";
    // 单点同一个code所有局部会话key
    private final static String ZHENG_UPMS_CLIENT_SESSION_IDS = "duobao-upms-client-session-ids";
    ...
    protected boolean isAccessAllowed(ServletRequest request, ServletResponse response, Object mappedValue) {
        ...
        // 判断请求类型
        String upmsType = PropertiesFileUtil.getInstance("duobao-upms-client").get("upms.type");
    ...
    protected boolean onAccessDenied(ServletRequest request, ServletResponse response) throws Exception {
        StringBuffer sso_server_url = new StringBuffer(PropertiesFileUtil.getInstance("duobao-upms-client").get("sso.server.url"));
        // server需要登录
        String upmsType = PropertiesFileUtil.getInstance("duobao-upms-client").get("upms.type");
        if ("server".equals(upmsType)) {
        ...
        sso_server_url.append("/sso/index").append("?").append("appid").append("=").append(PropertiesFileUtil.getInstance("duobao-upms-client").get("appID"));
        // 回跳地址
