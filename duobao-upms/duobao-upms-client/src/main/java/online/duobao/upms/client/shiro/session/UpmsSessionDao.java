package online.duobao.upms.client.shiro.session;

import online.duobao.common.util.RedisUtil;
import online.duobao.upms.client.util.SerializableUtil;
...
public class UpmsSessionDao extends CachingSessionDAO {
    ...
    // 会话key
    private final static String ZHENG_UPMS_SHIRO_SESSION_ID = "duobao-upms-shiro-session-id";
    // 全局会话key
    private final static String ZHENG_UPMS_SERVER_SESSION_ID = "duobao-upms-server-session-id";
    // 全局会话列表key
    private final static String ZHENG_UPMS_SERVER_SESSION_IDS = "duobao-upms-server-session-ids";
    // code key
    private final static String ZHENG_UPMS_SERVER_CODE = "duobao-upms-server-code";
    // 局部会话key
