...
import online.duobao.upms.dao.mapper.*;
import online.duobao.upms.dao.model.*;
import online.duobao.upms.rpc.api.UpmsApiService;
import online.duobao.upms.rpc.mapper.UpmsApiMapper;
...
public class UpmsApiServiceImpl implements UpmsApiService {
     ...
     */
    @Override
    @Cacheable(value = "duobao-upms-rpc-service-ehcache", key = "'selectUpmsPermissionByUpmsUserId_' + #upmsUserId")
     ...
     */
    @Override
    @Cacheable(value = "duobao-upms-rpc-service-ehcache", key = "'selectUpmsRoleByUpmsUserId_' + #upmsUserId")
