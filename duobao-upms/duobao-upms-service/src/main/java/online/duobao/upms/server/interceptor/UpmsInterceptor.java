package online.duobao.upms.server.interceptor;
...
//    private static final String ZHENG_OSS_ALIYUN_OSS_POLICY = PropertiesFileUtil.getInstance("duobao-oss-client").get("aliyun.oss.policy");
